...
export const registerTypedVariableCategory = (
  ...
  workspace.registerToolboxCategoryCallback(
    ...
    (ws: Blockly.WorkspaceSvg) => {
      ...
      contents.push({
        ...
        callbackkey: 'SC_VAR_CREATE',
      });
      contents.push({
        kind: 'button',
        text: 'Create number...',
        callbackkey: 'SC_VAR_CREATE_NUMBER',
      });
      contents.push({
        kind: 'button',
        text: 'Create integer...',
        callbackkey: 'SC_VAR_CREATE_INTEGER',
      });
      contents.push({
        kind: 'button',
        text: 'Create boolean...',
        callbackkey: 'SC_VAR_CREATE_BOOLEAN',
      });
      contents.push({
        kind: 'button',
        text: 'Create text...',
        callbackkey: 'SC_VAR_CREATE_TEXT',
      });
      contents.push({
        kind: 'button',
        text: 'Create list...',
        callbackkey: 'SC_VAR_CREATE_LIST',
      });
      contents.push({
        kind: 'button',
        text: 'Create object...',
        callbackkey: 'SC_VAR_CREATE_OBJECT',
      });
  ...
  workspace.registerButtonCallback('SC_VAR_CREATE_NUMBER', () =>
    promptVariableName(workspace, 'Number'),
  );
  workspace.registerButtonCallback('SC_VAR_CREATE_INTEGER', () =>
    promptVariableName(workspace, 'Integer'),
  );
  workspace.registerButtonCallback('SC_VAR_CREATE_BOOLEAN', () =>
    promptVariableName(workspace, 'Boolean'),
  );
  workspace.registerButtonCallback('SC_VAR_CREATE_TEXT', () =>
    promptVariableName(workspace, 'Text'),
  );
  workspace.registerButtonCallback('SC_VAR_CREATE_LIST', () =>
    promptVariableName(workspace, 'List'),
  );
